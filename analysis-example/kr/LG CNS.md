...
위 차트 이미지는 `2026-04-02`까지의 1년 일봉을 사용해 생성했다. 기준 종가는 `56,500원`, `5일선 58,380원`, `20일선 63,250원`, `60일선 66,583원`, `120일선 64,208원`, `볼린저 상단 70,354원`, `볼린저 하단 56,146원`, `전환선 60,350원`, `기준선 66,850원`, `현재 구름대 A 70,100원`, `현재 구름대 B 68,150원`, `RSI14 30.07`, `거래량/20일 평균 119.7%`였다.
