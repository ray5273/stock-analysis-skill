...
위 두 이미지는 `2026-04-02`까지의 1년 일봉을 사용해 생성했다. 첫 번째 이미지는 `캔들스틱`, `종가선`, `5/20/60/120일선`, `거래량`을, 두 번째 이미지는 `종가선`, `볼린저밴드`, `일목균형표`, `RSI14`를 보여준다. 기준 종가는 `56,500원`, `5일선 58,380원`, `20일선 63,250원`, `60일선 66,583원`, `120일선 64,208원`, `볼린저 상단 70,354원`, `볼린저 하단 56,146원`, `전환선 60,350원`, `기준선 66,850원`, `현재 구름대 A 70,100원`, `현재 구름대 B 68,150원`, `RSI14 30.07`, `거래량/20일 평균 119.7%`였다.
...
`2026-04-03` 장마감까지 반영한 새 분리형 차트는 아래 `## Update Log`의 `2026-04-04` 블록에 추가했다.
...
- `2026-04-03` 종가 `57,600원` 기준으로 LG CNS 메인 추세 차트와 오버레이 차트를 다시 생성했다. 메인 차트는 `캔들스틱 + 윗꼬리/아랫꼬리 + 종가선`, 한글 범례, 현재가 가이드 라인을 함께 표시하도록 바꿨다.
- 차트 지표는 `5일선 57,680원`, `20일선 62,885원`, `60일선 66,502원`, `120일선 64,156원`, `볼린저 상단 70,353원`, `볼린저 하단 55,417원`, `전환선 60,300원`, `기준선 66,850원`, `현재 구름대 A 71,250원`, `현재 구름대 B 68,150원`, `RSI14 35.40`, `거래량/20일 평균 49.3%`였다.
- 해석은 `약세 지속` 쪽이지만, `2026-04-02` 대비 종가가 `56,500원 -> 57,600원`으로 반등했고 RSI도 `30.07 -> 35.40`으로 올라와 극단적 과매도 압력은 조금 완화됐다. 다만 `20일선`, `60일선`, `120일선`, `구름대` 아래라는 큰 구조는 그대로다.
